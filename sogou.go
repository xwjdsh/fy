...
var n122 = {
                ...
                "endian": function(t) {
                    if (t.constructor == Number)
                        return 16711935 & n122.rotl(t, 8) | 4278255360 & n122.rotl(t, 24);
...
var n102 = {
            "utf8": {
                "stringToBytes": function(t) {
                    return n102.bin.stringToBytes(unescape(encodeURIComponent(t)))
                },
...
function sign(t, n) {
                ...
                var r = n122.wordsToBytes(a(t, n));
                return n && n.asBytes ? r : n && n.asString ? n102.bin.bytesToString(r) : n122.bytesToHex(r)
        }
